...
API_KEY = 'AIzaSyBsmSIK6I0fZrTzdJu7zjnJTqADqnw1cSA'
...
TABLE_ID = '1ygYi_UxoDAfhg249sUPql_2Sh1E7FgJv3mBRHyc_'

# This is the default columns for the query
query_cols = []
query_values = ['CARIBE'] #Change to be the value(s) you're querying in the column you've specified
...
def make_query(cols, values, limit):
   ...
   query = "SELECT * FROM " + TABLE_ID + " WHERE Region = 'CARIBE' "
